...
<body>
  ...
  <article>
        ...
        <section>
            <h2>S01</h2>
            <p>
                The general techniques of Git and GitHub were know to me, I had never worked with GitHub Pages before. I had
                ...
                I have never attached tags to any commit before.
            </p>
            <p>
                I have created several small websites using html and css. These were mostly to support programming with
                php.
            </p>
            <p>
                I have created several small web applications. I have worked with php using things like loops and statements,
                ...
                created a system using a REST architecture before.
            </p>
            <p>
                I learned to set up the GitHub Pages functionality. I also learned that an html page called index.html will
                be displayed if a folder is targeted that contains that html page. I learned to attach tags to commit to
                disply the release version of that commit.
            </p>
        </section>
        ...
        <section>
            <h2>S02</h2>
            <p>
                I have some experience with html and css. I have made several website using html and an occasional one using
                css, although my css knowledge is very little. I have used JavaScipt once before and only in a single case.
                My JavaScript knowledge is absolutely minimal.
            </p>
            <p>
                According to MDN one can state that HTML defines the meaning and structure of web content. It is used to
            ...
            <p>
                The browser sends an HTTP request to the web server for a specific page. The browser then returns an HTTP
                response which may contain the requested page in an HTML format for example.
            </p>
            <p>
                I learned some syntaxes for html (such as linking the stylesheet). I also learned about some semantic
                elements in HTML (such as header and footer). Finally I learned some syntax of css and roughly how it will
                influence the html page it is linked to.
            </p>
        </section>
        ...
        <section>
            ...
            <p><img src="../work/pngfiles/comparison.png" width="400" alt="Comparison image"></p>
